...
| [Agent Workflow Boundary Guide](./agent-workflow-boundary.md) | Trellis owns the workflow; minimization rules only shape implementation code | Whenever a minimization ruleset prompts you to skip a Trellis task or artifact |
